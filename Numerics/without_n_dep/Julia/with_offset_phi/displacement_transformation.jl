#Path of this file: "C:/Users/Jan-Philipp/Documents/Eigene Dokumente/Physikstudium/6. Semester/Bachelor-Thesis/Numerics/without_n_dep/Julia/with_offset_phi/displacement_transformation.jl"
import NPZ, NLsolve
using NPZ, NLsolve
...
for eta in LinRange(-10,10,201)
    ...
    npzwrite(PATH*"Ham_eta="*string(round(eta,digits = 3))*",N="*string(length(grid))*",lambda_IR="*string(lamb_IR)*",lambda_UV="*string(lamb_UV)*",phi="*string(phi)*".npy",ret)
end
