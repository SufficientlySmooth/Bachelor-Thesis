#Path of this file: "C:/Users/Jan-Philipp/Documents/Eigene Dokumente/Physikstudium/6. Semester/Bachelor-Thesis/Numerics/without_n_dep/Julia/with_offset_phi/solve_flow_complex_perturbation.jl"
import NPZ
...
for name in readdir(PATH)#[end:-1:1]
    ...
    if FILENAME ∉ readdir(SAVEPATH) && eta >= eta_bounds[1] && eta < eta_bounds[2] && isinteger(5*eta)
        ...
        pert = 1e-4
        om0 = om0 + diag(V0) + ones(N)*1im*pert      
