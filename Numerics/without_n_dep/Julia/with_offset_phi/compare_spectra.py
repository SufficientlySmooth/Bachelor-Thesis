...
ax.plot(etas,[eigvals[-1] for eigvals in eigvals_flow],marker='x',color = 'lime',markersize=5,linestyle='None',label = 'via flow')
#ax.plot(etas,[eigvals[-1] for eigvals in eigvals_flow_and_bog],marker='+',color='firebrick',markersize=5,linestyle='None',label = 'via flow and Bogoliubov')
ax.plot(etas_bog,[eigvals[-1] for eigvals in eigvals_bog],marker='o',color='steelblue',markersize=4,linestyle='None',label = 'via Bogoliubov')

ax.plot(etas,[eigvals[-2] for eigvals in eigvals_flow],marker='+',color = 'lime',markersize=5,linestyle='None',label = 'via flow')
#ax.plot(etas,[eigvals[-2] for eigvals in eigvals_flow_and_bog],marker='o',color='firebrick',markersize=5,linestyle='None')#,label = r'$2^{\mathrm{nd}}$ largest $\omega$ flow and Bogoliubov')
ax.plot(etas_bog,[eigvals[-2] for eigvals in eigvals_bog],marker='.',color='steelblue',markersize=4,linestyle='None',label = 'via Bogoliubov')


for i in range(0,3):
    ax.plot(etas,[eigvals[-3-2*i] for eigvals in eigvals_flow],marker='x',color = 'lime',markersize=5,linestyle='None')
    #ax.plot(etas,[eigvals[-3-2*i] for eigvals in eigvals_flow_and_bog],marker='+',color='firebrick',markersize=5,linestyle='None')
    ax.plot(etas_bog,[eigvals[-3-2*i] for eigvals in eigvals_bog],marker='o',color='steelblue',markersize=4,linestyle='None')
    
    ax.plot(etas,[eigvals[-3-2*i-1] for eigvals in eigvals_flow],marker='+',color = 'lime',markersize=5,linestyle='None')
    #ax.plot(etas,[eigvals[-3-2*i-1] for eigvals in eigvals_flow_and_bog],marker='o',color='firebrick',markersize=5,linestyle='None')
    ax.plot(etas_bog,[eigvals[-3-2*i-1] for eigvals in eigvals_bog],marker='.',color='steelblue',markersize=4,linestyle='None')

"""
ax.plot(etas,[eigvals[0] for eigvals in eigvals_flow],marker='x',color = 'lime',markersize=5,linestyle='None',label = 'via flow')
#ax.plot(etas,[eigvals[-1] for eigvals in eigvals_flow_and_bog],marker='+',color='firebrick',markersize=5,linestyle='None',label = 'via flow and Bogoliubov')
ax.plot(etas_bog,[eigvals[0] for eigvals in eigvals_bog],marker='o',color='steelblue',markersize=4,linestyle='None',label = 'via Bogoliubov')

ax.plot(etas,[eigvals[1] for eigvals in eigvals_flow],marker='+',color = 'lime',markersize=5,linestyle='None',label = 'via flow')
#ax.plot(etas,[eigvals[-2] for eigvals in eigvals_flow_and_bog],marker='o',color='firebrick',markersize=5,linestyle='None')#,label = r'$2^{\mathrm{nd}}$ largest $\omega$ flow and Bogoliubov')
ax.plot(etas_bog,[eigvals[1] for eigvals in eigvals_bog],marker='.',color='steelblue',markersize=4,linestyle='None',label = 'via Bogoliubov')


for i in range(0,5):
    ax.plot(etas,[eigvals[2*i] for eigvals in eigvals_flow],marker='x',color = 'lime',markersize=5,linestyle='None')
    #ax.plot(etas,[eigvals[-3-2*i] for eigvals in eigvals_flow_and_bog],marker='+',color='firebrick',markersize=5,linestyle='None')
    ax.plot(etas_bog,[eigvals[2*i] for eigvals in eigvals_bog],marker='o',color='steelblue',markersize=4,linestyle='None')
    
    ax.plot(etas,[eigvals[2*i+1] for eigvals in eigvals_flow],marker='+',color = 'lime',markersize=5,linestyle='None')
    #ax.plot(etas,[eigvals[-3-2*i-1] for eigvals in eigvals_flow_and_bog],marker='o',color='firebrick',markersize=5,linestyle='None')
    ax.plot(etas_bog,[eigvals[2*i+1] for eigvals in eigvals_bog],marker='.',color='steelblue',markersize=4,linestyle='None')
...
plt.tight_layout()
plt.savefig('Spectral_analysis.pdf',dpi=300)
plt.show()