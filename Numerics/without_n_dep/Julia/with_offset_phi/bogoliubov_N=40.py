...
plt.tight_layout()
plt.savefig('GS_energies_bog_flow_comp_N=40.pdf',dpi=300)
plt.show()
...
smallest_real_eigvals_flow = np.array(smallest_real_eigvals_flow)
smallest_real_eigvals_bog = np.array(smallest_real_eigvals_bog)
smallest_real_eigvals_flow_and_bog = np.array(smallest_real_eigvals_flow_and_bog)
...
ax2.plot(np.array(etas_bog)[eta_filter_bog],np.array(imag_eigvals_list_bog)[eta_filter_bog],marker='+',color='steelblue',linestyle='None',label='direct Bogoliubov',markersize=4)
...
ax2.legend(loc='best',fontsize=10)
plt.tight_layout()
plt.savefig('spectrum_analysis_bog_flow_comp_N=40.pdf',dpi=300)
plt.show()
