...
% -- english -- %
\newcommand{\getTitleEN}{The Flow Equation Approach for Quadratic Bosonic Hamiltonians}
...
\newcommand*{\getSubmissionDateEN}{July 04, 2023}
\newcommand*{\langEN}{en-US}
% -- german -- %
\newcommand{\getTitleDE}{Der Flow Equation Ansatz für quadratische bosonische Hamiltonians }
...
\newcommand*{\getSubmissionDateDE}{04.07.2023}
%\newcommand*{\langDE}{de}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
