...
\newcommand*{\getSubmissionDateEN}{July 2023}
\newcommand*{\langEN}{en-US}
% -- german -- %
\newcommand{\getTitleDE}{Der Flow Equation Ansatz für qudratische bosonische Hamiltonians }
...
\newcommand*{\getSubmissionDateDE}{01.07.2023}
%\newcommand*{\langDE}{de}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
