...
\usepackage{mathrsfs} % for curly H: \mathscr{H} in math mode
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% -- english -- %
\newcommand{\getTitleEN}{Flow Equation Approach to Bosonic Impurity Problems}
...
\newcommand*{\getSubmissionDateEN}{July {\color{red}tba}, 2023}
\newcommand*{\langEN}{en-US}
% -- german -- %
\newcommand{\getTitleDE}{Flow Equation Ansatz für bosonische Impurity Probleme }
...
\newcommand*{\getSubmissionDateDE}{{\color{red}tba}.07.2023}
%\newcommand*{\langDE}{de}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
